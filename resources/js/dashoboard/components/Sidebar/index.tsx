      ...
      <div className="py-5.5 lg:py-6.5 flex items-center justify-between gap-2 px-6">
        <NavLink to="/">
          <img
            ...
            src="https://placehold.co/500x50/000000/FFF?text=Task+Scheduler&font=Montserrat"
            alt="Logo"
          />
          <img
            className="rounded-lg dark:hidden"
            src="https://placehold.co/500x150/000000/FFF?text=Task+Scheduler&font=Montserrat"
            alt="Logo"
          />
        </NavLink>
