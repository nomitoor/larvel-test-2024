...
const SendMessage: React.FC<IProps> = ({ activeUser }) => {
  ...
  useEffect(() => {
    window.Echo.join(`message.1`)
      .here((data) => {
        console.log("im in here");
        console.log(data);
      })
      .joining((data) => {
        console.log("im in joining");
        console.log(data);
      });
  }, []);

  return (
    <div className="border-stroke dark:border-strokedark dark:bg-boxdark sticky bottom-0 border-t bg-white px-6 py-5">
      <form
        onSubmit={handleSendMessage}
        className="space-x-4.5 flex items-center justify-between"
      ...
      >
        <div className="relative w-full">
          <input
            ...
            className="h-13 border-stroke bg-gray pr-19 placeholder-body focus:border-primary dark:border-strokedark dark:bg-boxdark-2 w-full rounded-md border pl-5 text-black outline-none dark:text-white"
          />
          {/*<div*/}
          ...
          {/*            <path fill-rule="evenodd" clip-rule="evenodd"*/}
          {/*                  d="M6.5 6.75C6.5 6.33579 6.83579 6 7.25 6H7.2575C7.67171 6 8.0075 6.33579 8.0075 6.75C8.0075 7.16421 7.67171 7.5 7.2575 7.5H7.25C6.83579 7.5 6.5 7.16421 6.5 6.75Z"></path>*/}
          {/*            <path fill-rule="evenodd" clip-rule="evenodd"*/}
          {/*                  d="M11 6.75C11 6.33579 11.3358 6 11.75 6H11.7575C12.1717 6 12.5075 6.33579 12.5075 6.75C12.5075 7.16421 12.1717 7.5 11.7575 7.5H11.75C11.3358 7.5 11 7.16421 11 6.75Z"></path>*/}
          {/*        </svg>*/}
          {/*    </button>*/}
          {/*</div>*/}
        </div>
        <button className="h-13 max-w-13 bg-primary flex w-full items-center justify-center rounded-md text-white hover:bg-opacity-90">
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
          ...
          >
            <path d="M22 2L11 13" stroke="white"></path>
            <path d="M22 2L15 22L11 13L2 9L22 2Z" stroke="white"></path>
          </svg>
        </button>
      </form>
    </div>
